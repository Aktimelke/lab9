...
public class Controller {
    ...
    private Questions[] questionsСС = new Questions[] {
    ...
    public void Test(Questions[] questions){
        //инициализация в начале запуска каждого теста
        correctAnswers = 0;
        nowQuestion = 0;
        ...
        answerBtn.setOnAction(e -> {
            ...
            if(selectedRadioButton != null || checkBox) {
                ...
                if(nowQuestion + 1 == questions.length){    // отдельная проверка чекбоксов
